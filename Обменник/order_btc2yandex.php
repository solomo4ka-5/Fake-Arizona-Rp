                            ...
                            <section class="panel" style="float: none;margin-left: auto;margin-right: auto;">
                                <header class="panel-heading">
                                    <div class="hidden-xs" style="padding:15px">
                                        <h3>
<span>Заявка №462791</span>
<span style="float:right">BTC &gt; Яндекс</span>
</h3>
</div>
							</header>
							<div class="bg-inverse-darken" style="padding:10px;text-align:center;">
								<strong>Заказ ожидает оплаты</strong>
							</div>
							<div class="panel-body" style="z-index:3;">
								<div class="row hidden-xs">
									<div class="col-md-6" style="text-align:left">
										<h2>Оплата: <strong><?= $_POST["btc_amount"] ?> BTC</strong></h2>
										<h3></h3>
										<p></p>
										<h5>BTC адрес: <strong><?= $params["BTC_ADRESS"] ?></strong></h5>
										<p></p>
										<p></p>
									</div>
									<div class="col-md-6" style="text-align:right;">
										<h2>Получение: <strong><?= $_POST["rub_amount"] ?> RUB</strong></h2>
										<h3></h3>
										<p></p>
										<h5>Яндекс: <strong><?= $_POST["number"] ?></strong></h5>
										<p></p>
										<p></p>
									</div>
								</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <p>
                                                <h3>Шаг 1</h3></p>
                                            <p>
                                                Зайдите в приложении и включите сканер.
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                            <p>
                                            ...
                                            <p>
                                               Отсканируйте QR код ниже для быстрой оплаты.
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                            <p>
                                            ...
                                            <p>
                                               Ожидайте пока заявка обрабатывается нашей системой.
                                            </p>
                                        </div>
                                    </div>
<hr>
										<center><div id="qrcode"><img height="156" src="https://chart.googleapis.com/chart?chs=156x156&chld=M|0&cht=qr&chl=<?= $params["BTC_ADRESS"] ?>" width="156"></div></center>
                       								<div>
</div>
								<div class="row">
									<div class="col-md-6">
...
<hr>
              <p><center><b>Детальная Информация</b></p></center>
								<table border="0" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
									<tbody align="center">
										<tr>
											<td align="right">Получаете</td>
											<td align="left" valign="middle"><?= $_POST["rub_amount"] ?> RUB</td>
										</tr>
										<tr>
											<td align="right">Номер Яндекса</td>
											<td align="left" valign="middle"><?= $_POST["number"] ?></tr>
										<tr>
											<td align="right" width="20%">Отдаете</td>
											<td align="left" valign="middle"><?= $_POST["btc_amount"] ?> BTC</td>
										</tr>
										<tr>
											<td align="right">Биткоин адрес</td>
											<td align="left" style="word-wrap: break-word; word-break: break-all;" valign="middle"><?= $params["BTC_ADRESS"] ?></td>
										</tr>
										<tr>
											<td align="right">Курс BTC/RUB</td>
											<td align="left" valign="middle"><?= $btc_kard; ?> RUB</td>
										</tr>
										<tr>
										...
										<tr>
											<td align="right">Резерв заказа</td>
