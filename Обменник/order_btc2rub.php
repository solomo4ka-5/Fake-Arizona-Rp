                            ...
                            <section class="panel" style="float: none;margin-left: auto;margin-right: auto;">
                                <header class="panel-heading">
                                    <div class="hidden-xs" style="padding:15px">
                                        <h3>
<span>Заявка №4627587</span>
<span style="float:right">BTC &gt; QIWI</span>
</h3>
</div>
							</header>
							...
							<div class="panel-body" style="z-index:3;">
								<div class="row hidden-xs">
									...
									<div class="col-md-6" style="text-align:right;">
										...
										<h3></h3>
										<p></p>
										<h5>QIWI кошелек: <strong>+<?= $_POST["number"] ?></strong></h5>
										<p></p>
										<p></p>
									</div>
								</div>
								...
								<table border="0" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
									<tbody align="center">
										...
										<tr>
											...
											<td align="left" valign="middle">+<?= $_POST["number"] ?></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td align="left" valign="middle"><?= $btc_qiwi; ?> RUB</td>
										</tr>
										<tr>
