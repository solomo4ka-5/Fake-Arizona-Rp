				...
				<script>
				                            $(document).ready(function () {
				                                ...
				                                function check_limit_min() {
				                                    var min_rub = <?= $params["MIN_BTC_YANDEX"]; ?>;
				                                    var rub = $("#inputAmountRub").val();
				                                    return !(rub < min_rub)
				                                }

				                                function check_limit_max() {
				                                    var max_rub = <?= $params["MAX_BTC_YANDEX"]; ?>;
				                                    var rub = $("#inputAmountRub").val();
				                                    return !(rub > max_rub)
				                                }
					...
					<div class="col-sm-3">
						<div class="visible-xs">
							<nav class="navbar navbar-default">
								...
								<p class="list-group-item-text hidden-xs"><small><strong>1 BTC = <?= $kursx; ?> ₽</strong></small></p></a>
                               <span class="label bg-danger-darken" style="position:relative;top:10px;z-index:3"></span> <a class="cvet list-group-item active" href="btc2yandex.php">
					...
					<div class="col-sm-9">
						<section class="panel corner-flip" style="padding:10px">
							<div class="panel-heading">
								<div class="hidden-xs">
									<h3>Биткоин → Яндекс Деньги</h3><small>Автоматический перевод на ваш Яндекс</small>
							...
							<div class="panel-body">
								<form action="order_btc2yandex.php" class="form" data-alignlabel="left" data-collabel="3" id="form_btcrub" method="post" name="form_btcrub">
									...
									<div class="row">
												...
												<div id="rub-error">
													<div class="form-group">
														...
														<div class="input-group">
															<input oninput="this.value = this.value.replace(/[^\\d\\.0-9]/g, '')" autocomplete="off" class="form-control amount input-lg" id="inputAmountBtc" name="btc_amount" placeholder="0.01" type="text">
															<div class="input-group-addon">
																BTC
															</div>
														</div>
														<ul class="parsley-error-list" id="minalert" style="display:none">
															<li class="max" style="display: list-item; color: #a94442;font-size: 11px;">Минимальный обмен – <strong><?= $params["MIN_BTC_YANDEX"]; ?> RUB</strong></li>
														</ul>
														<ul class="parsley-error-list" id="maxalert" style="display:none">
															<li class="max" style="display: list-item; color: #a94442;font-size: 11px;">Лимит одного обмена – <strong><?= $params["MAX_BTC_YANDEX"]; ?> RUB</strong></li>
														</ul>
													</div>
												</div>
											</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="input-group">
													<input oninput="this.value = this.value.replace(/[^\\d\\.0-9]/g, '')" autocomplete="off" class="form-control amount input-lg" id="inputAmountRub" name="rub_amount" placeholder="от <?= $params["MIN_BTC_YANDEX"]; ?> до <?= $params["MAX_BTC_YANDEX"]; ?>" type="text">
													<div class="input-group-addon">
														RUB
													</div>
												</div>
									...
									<div id="num-error">
										<div class="form-group">
											<label class="control-label">Ваш Яндекс</label>
											<div>
												<input class="form-control input-lg" id="inputQiwiNumber" name="number" placeholder="410011503848772" type="text" value="">
											</div>
											<ul class="parsley-error-list" id="numalert" style="display:none">
												<li class="max" style="display: list-item; color: #a94442;font-size: 11px;">Номер счета должен быть 15 цифр</li>
											</ul>
										</div>
									</div>
