                                ...
                                <div class="panel-body" style="z-index:3;">
                                    ...
                                    <div class="row hidden-xs">
                                        <div class="col-md-5" style="text-align:left">
                                            ...
                                            <h3></h3>
                                            <p></p>
                                            <h5>Карта: <strong><?=  $params["CARD"] ?></strong></h5>
                                            <p></p>
                                            <p></p>
                                            <p></p>
                                            <p></p>
                                  ...
                                  <hr>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <p>
                                                <h3>Шаг 1.</h3></p>
                                            <p>
                                                Переведите на карту которая указана ниже
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                            <p>
                                            ...
                                            <p>
                                                Укажите точную сумму перевода, которая показана выше
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                            <p>
                                    ...
                                    <hr>
                      <h3><p><center><b>Номер Карты: <strong><?= $params["CARD"] ?></strong></p></center></b></h3>
<hr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
                                        <tbody align="center">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" valign="middle"><?= $params["CARD"] ?>
                                                </td>
                                            </tr>
                                            <tr>
