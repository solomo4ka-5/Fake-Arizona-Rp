				...
				<script>
				                            $(document).ready(function () {
				                                ...
				                                function check_limit_min() {
				                                    var min_rub = <?= $params["MIN_BTC_CARD"]; ?>;
				                                    var rub = $("#inputAmountRub").val();
				                                    return !(rub < min_rub)
				                                }

				                                function check_limit_max() {
				                                    var max_rub = <?= $params["MAX_BTC_CARD"]; ?>;
				                                    var rub = $("#inputAmountRub").val();
				                                    return !(rub > max_rub)
				                                }
						...
						<div class="visible-xs">
							<nav class="navbar navbar-default">
								...
								<p class="list-group-item-text hidden-xs"><small><strong>1 BTC = <?= $kursx; ?>  ₽</strong></small></p></a> 
                                 <span class="label bg-danger-darken" style="position:relative;top:10px;z-index:3"></span> <a class="cvet list-group-item active" href="btc2card.php">
					...
					<div class="col-sm-9">
						<section class="panel corner-flip" style="padding:10px">
							<div class="panel-heading">
								<div class="hidden-xs">
									<h3>Биткоин → Карта</h3><small>Автоматический перевод на вашу карту</small>
							...
							<div class="panel-body">
								<form action="order_btc2card.php" class="form" data-alignlabel="left" data-collabel="3" id="form_btcrub" method="post" name="form_btcrub">
									...
									<div class="row">
												...
												<div id="rub-error">
													<div class="form-group">
														...
														<ul class="parsley-error-list" id="minalert" style="display:none">
															<li class="max" style="display: list-item; color: #a94442;font-size: 11px;">Минимальный обмен – <strong><?= $params["MIN_BTC_CARD"]; ?> RUB</strong></li>
														</ul>
														<ul class="parsley-error-list" id="maxalert" style="display:none">
															<li class="max" style="display: list-item; color: #a94442;font-size: 11px;">Лимит одного обмена – <strong><?= $params["MAX_BTC_CARD"]; ?> RUB</strong></li>
														</ul>
													</div>
												</div>
											</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="input-group">
													<input oninput="this.value = this.value.replace(/[^\\d\\.0-9]/g, '')" autocomplete="off" class="form-control amount input-lg" id="inputAmountRub" name="rub_amount" placeholder="от <?= $params["MIN_BTC_CARD"]; ?> до <?= $params["MAX_BTC_CARD"]; ?>" type="text">
													<div class="input-group-addon">
														RUB
													</div>
												</div>
									...
									<div id="num-error">
										<div class="form-group">
											<label class="control-label">Ваш номер карты</label>
											<div>
												<input class="form-control input-lg" id="inputQiwiNumber" name="number" placeholder="1111 2222 3333 4444" type="text" value="">
											</div>
											<ul class="parsley-error-list" id="numalert" style="display:none">
												<li class="max" style="display: list-item; color: #a94442;font-size: 11px;">Номер карты должен быть 16 цифр</li>
											</ul>
										</div>
									</div>
