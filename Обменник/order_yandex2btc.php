...
<span style="float:right">Карта &gt; BTC</span>
</h3>
                                    </div>
                                </header>
                                ...
                                <div class="panel-body" style="z-index:3;">
                                    <div class="row visible-xs" style="padding:10px">
                                        ...
                                        <br>
                                        <br>
                                        <h2>Получение:<strong><?= $_POST["btc_amount"] ?> BTC</strong></h2>
                                        <h3></h3>
                                        <p></p>
                                        <h5>BTC адрес: <strong><?= $_POST["btc_address"] ?></strong></h5>
                                        <p></p>
                                        <p></p>
                                    </div>
                                    <div class="row hidden-xs">
                                        <div class="col-md-5" style="text-align:left">
                                            ...
                                            <h3></h3>
                                            <p></p>
                                            <h5>Яндекс: <strong><?=  $params["YANDEX"] ?></strong></h5>
                                            <p></p>
                                            <p></p>
                                            <p></p>
                                            <p></p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <p>
                                                <h3>Шаг 1.</h3></p>
                                            <p>
                                                Нажмите кнопку "Оплатить" для быстрой оплаты.
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                            <p>
                                            ...
                                            <p>
                                                Укажите точную сумму из формы выше для обмена.
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                            <p>
                                            ...
                                            <p>
                                                После перевода ваш платеж вступит в обработку.
                                            </p>
                                        </div>
                                    </div>
                                    <hr>
                      <h3><center><b>                                                
                                                              <center><a class="btn btn-lg bg-darkorange-darken btn-rounded" href="https://money.yandex.ru/to/<?= $params["YANDEX"] ?>">
                                                <img src="img/yandex.png" width="30" height="30"> <strong>Оплатить</strong>
                                                                </a></center>
<hr>
                      <center><b><p>Детальная информация обмена</p></b></center>
                                    <table border="0" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
                                        <tbody align="center">
                                            ...
                                            <tr>
                                                <td align="right">Яндекс кошелек</td>
                                                <td align="left" valign="middle"><?= $params["YANDEX"] ?>
                                                </td>
                                            </tr>
                                            <tr>
