...
<body>
	<div id="wrapper">
		...
		<script> setTimeout('$("#lox").fadeOut(5000)',7500); </script>
		        ...
		        <div id="vue">
            <nav class="uk-navbar">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="uk-navbar-brand"><a href="index.html"><span class="two">BTC</span><span class="one">FREE</span><span class="three" id="do1">.NET</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<font face="Open Sans" size=3>
            <strong> <a href="index.php" class="fa fa-home" > ГЛАВНАЯ</a>&nbsp
              <a href="rules.html" class="fa fa-users"> ПРАВИЛА</a>&nbsp;
             <a href="faq.html" class="fa fa-question-circle"> ВОПРОСЫ</a>&nbsp;</strong>
              </font>
</a>
</div>
</div>
            ...
            <div id="main">
                <div class="container-fluid" id="content">
                    <div class="hidden-xs" style="float: right;margin-right: auto;">
                        <a href="request" class="" target="_self">
                        </a>
                    </div>
                    <div class="visible-xs">
                        <div class="navbar navbar-fixed-top">
                            <a href="request" class="" style="float:right;margin:5px" data-vertical="left" target="_self">
...
<span style="float:right">QIWI &gt; BTC</span>
                                ...
                                <div class="panel-body" style="z-index:3;">
                                    ...
                                    <div class="row hidden-xs">
                                        <div class="col-md-5" style="text-align:left">
                                            <h2>Отдаете</h2>
                                            <h3><strong><?= $_POST["rub_amount"] ?> RUB</strong></h3>
                                            <p></p>
                                            <h5><nobr>На QIWI кошелек</nobr></h5>
                                            <p></p>
                                            <p><strong><?= $params["NUMBER"] ?></strong></p>
                                            <p></p>
                                            <p></p>
                                            <a class="btn btn-lg bg-darkorange-darken btn-rounded" href="https://qiwi.com/payment/form/99?extra%5B%27account%27%5D=<?= $params["NUMBER"] ?>&amountInteger=<?= $_POST["rub_amount"] ?>&amountFraction=0&extra%5B%27comment%27%5D=&currency=643&blocked[0]=account" target="qiwi">
                                                <img src="img/qiwi_logo_button2x.png" width="30" height="30"> <strong>Оплатить через QIWI</strong>
                                            </a>
                                        </div>
                                        <div class="col-md-7" style="text-align:right;">
                                            ...
                                            <p></p>
                                            <p>
                                                <nobr><strong><?= $_POST["btc_address"] ?></strong></nobr>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <p>
                                                <h3>Шаг 1.</h3></p>
                                            <p>
                                                Нажмите на кнопку Оплатить через QIWI, войдите в свой кошелек
                                                <strong></strong> . <span class='text-danger'>Перевод с терминала или с другого номера будет утерян и возврату не подлежит.</span>
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                            <p>
                                            ...
                                            <p>
                                                Не заполняйте поле комментарий, это отменит заказ.
                                            </p>
                                        </div>
                                        <div class="col-md-4">
                                            <p>
                                            ...
                                            <p>
                                                После перевода подождите 1 миинуту. Эта страница обновится автоматически.
                                            </p>
                                        </div>
                                    </div>
                                    <hr>
                      <center><b><p>Детальная информация обмена</p></b></center>
                                    <table border="0" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
                                        <tbody align="center">
                                            ...
                                            <tr>
                                                <td align="right">Резерв биткоинов до</td>
                                    ...
                                    <div class="text-danger" style="padding:20px;text-align:center">
                                        Эта страница не индексируется поисковыми роботами.
                                        <br> Она будет удалена через сутки после закрытия или отмены заявки.
                                    </div>
                                </div>
                            </section>
                        </div>
                ...
                <footer class="footer" id="site-footer" style="margin-top:100px; background-color:#1C1D1F;color:#6f7b8a">
                    <section class="section bottom">
                        <div class="container">
                            <div class="row hidden-xs" style="padding:50px">
                                <div class="col-xs-6" valign="middle">
                                    <div class="color-white" style="    margin-top: -9px;">
                                        <small style="margin-top: -20px;">
© 2005-2018 KONVERT<br>
ZEN SYSTEM SOLUTIONS PTE. LTD.<br>
79 Ayer Rajah Crescent #05-08 Singapore 139955
</small>
                                    </div>
                                </div>
                                <div class="col-xs-6" valign="middle" style="text-align:right; margin-top: 15px;">
                                    <a href="agreement" class="color-white">Соглашение об использовании</a> &nbsp;|&nbsp;
                                    <a href="request" target="_self" class="color-white">Связь с администрацией</a> &nbsp;|&nbsp;
                                    <a href="agreement" target="_self" class="color-white">Справка</a>
                                </div>
                            </div>
                            <div class="visible-xs text-center">
                                <a href="request" target="_self" class="color-white"><strong>Обратная связь</strong></a>
                                <br>
                                <br>
...
79 Ayer Rajah Crescent #05-08 Singapore 139955
        ...
        <!--]-->
        <div style="text-align:center;font-size:11px" class="cbalink"><a href="https://www.zzz.com.ua/" title="&#1073;&#1077;&#1089;&#1087;&#1083;&#1072;&#1090;&#1085;&#1099;&#1081; &#1093;&#1086;&#1089;&#1090;&#1080;&#1085;&#1075;">&#1073;&#1077;&#1089;&#1087;&#1083;&#1072;&#1090;&#1085;&#1099;&#1081; &#1093;&#1086;&#1089;&#1090;&#1080;&#1085;&#1075;</a> ZZZ.COM.UA
            <br/>
            <br/>
        </div>
