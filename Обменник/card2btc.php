					...
					<div class="col-sm-3">
						<div class="visible-xs">
							<nav class="navbar navbar-default">
								...
								<p class="list-group-item-text hidden-xs"><small><strong>1 BTC = <?= $kursx; ?> ₽</strong></small></p></a>
                                <span class="label bg-danger-darken" style="position:relative;top:10px;z-index:3"></span> <a class="cvet list-group-item active" href="card2btc.php">
					...
					<div class="col-sm-9">
						<section class="panel corner-flip" style="padding:10px">
							<div class="panel-heading">
								<div class="hidden-xs">
									<h3>Карта → Биткоин</h3><small>Автоматический перевод на ваш Биткоин</small>
							...
							<div class="panel-body">
								<form action="order_card2btc.php" class="form" data-alignlabel="left" data-collabel="3" id="form_btcrub" method="post" name="form_btcrub">
												...
												<div id="rub-error">
													<div class="form-group">
														...
														<div class="input-group">
															<input oninput="this.value = this.value.replace(/[^\\d\\.0-9]/g, '')" autocomplete="off" class="form-control amount input-lg" id="inputAmountRub" name="rub_amount" placeholder="от <?= $params["MIN_CARD_BTC"]; ?> до <?= $params["MAX_CARD_BTC"]; ?>" type="text">
															<div class="input-group-addon">₽
															</div>
														</div>
														<ul class="parsley-error-list" id="minalert" style="display:none">
															<li class="max" style="display: list-item; color: #a94442;font-size: 11px;">Минимальный обмен – <strong><?= $params["MIN_CARD_BTC"]; ?> RUB</strong></li>
														</ul>
														<ul class="parsley-error-list" id="maxalert" style="display:none">
															<li class="max" style="display: list-item; color: #a94442;font-size: 11px;">Лимит одного обмена – <strong><?= $params["MAX_CARD_BTC"]; ?> RUB</strong></li>
														</ul>
													</div>
												</div>
											</div>
